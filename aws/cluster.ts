...
const nodes = 3;
// x86_64 to match Restate's Docker CI artifacts; larger instances suit tests with many partitions
const instanceType = new ec2.InstanceType(app.node.tryGetContext("instance-type") || "t3.small");
